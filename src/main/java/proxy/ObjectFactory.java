...
public class ObjectFactory {
    ...
    private final static QName _GetReleve_QNAME = new QName("http://wepservice.project2.enset.ma/", "GetReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://wepservice.project2.enset.ma/", "GetReleveResponse");
    private final static QName _Operation_QNAME = new QName("http://wepservice.project2.enset.ma/", "operation");
    private final static QName _Operations_QNAME = new QName("http://wepservice.project2.enset.ma/", "operations");
    private final static QName _Releve_QNAME = new QName("http://wepservice.project2.enset.ma/", "releve");
     ...
     */
    @XmlElementDecl(namespace = "http://wepservice.project2.enset.ma/", name = "GetReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://wepservice.project2.enset.ma/", name = "GetReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wepservice.project2.enset.ma/", name = "operation")
     ...
     */
    @XmlElementDecl(namespace = "http://wepservice.project2.enset.ma/", name = "operations")
     ...
     */
    @XmlElementDecl(namespace = "http://wepservice.project2.enset.ma/", name = "releve")
